...
<body ng-app="chatApp">
	...
	<script
		src="${pageContext.request.contextPath}/resources/references/js/app.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/resources/references/js/controllers.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/resources/references/js/services.js"
		type="text/javascript"></script>
</body>
